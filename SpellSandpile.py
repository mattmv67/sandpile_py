...
class SpellSandpile(Sandpile):
    ...
    def __init__(self, height: int, width: int, value_dict, color_mapping={0: (157, 2, 255),1: (182, 57, 191),2: (206, 112, 128),3: (231, 167, 64),"default": (255, 222, 0)}):
        ...
        for key, value in value_dict.items():
            self.grid.set_cell_value(key[0], key[1], value)
    ...
    def generate(self):
        ...
        while self.grid.iterate():
            if self.grid.tick % 100 == 0:
                ...
                rgbs = ColorMapper(raw, self.color_mapping).map()
